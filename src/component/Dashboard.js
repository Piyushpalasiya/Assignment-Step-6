...
//         return await axios
//           .get(
//             `http://localhost:3000/users?_sort=${filterOrSortValue}&_order=asc&_start=${start}&_end=${end}`
//           )
//           .then((response) => {
//             setData(response.data);
//             setCurrentPage(currentPage + increase);
...
//         return await axios
//           .get(
//             `http://localhost:3000/users?status=${filterOrSortValue}&_order=asc&_start=${start}&_end=${end}`
//           )
//           .then((response) => {
//             setData(response.data);
//             setCurrentPage(currentPage + increase);
...
//             name=""
//             id=""
//             style={{ width: "60%", borderRadius: "2px", height: "30px" }}
//             onChange={HandleSort}
//             value={sortValue}
//           >
